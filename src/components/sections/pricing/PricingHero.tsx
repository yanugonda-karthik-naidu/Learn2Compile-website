  ...
  return (
    <group ref={groupRef}>
      ...
      <Float speed={1.5} floatIntensity={0.4} rotationIntensity={0.2}>
        <mesh ref={panelRef2} position={[-1.6, 0.4, 0.3]} rotation={[0, 0.4, 0]}>
      ...
      <Float speed={1.0} floatIntensity={0.25} rotationIntensity={0.12}>
        <mesh ref={panelRef3} position={[1.5, 0.3, 0.2]} rotation={[0, -0.35, 0]}>
      ...
      <Float speed={0.8} floatIntensity={0.2} rotationIntensity={0.1}>
        <mesh ref={panelRef4} position={[0.3, 1.2, 0.1]} rotation={[0, 0.1, 0]}>
