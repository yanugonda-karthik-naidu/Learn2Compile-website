...
const servicesPanelItems = [
  {
    title: "Business Websites",
    description: "Professional websites designed to establish trust and generate inquiries.",
  },
  {
    title: "Portfolio Websites",
    description: "Showcase your work and credibility with a modern online presence.",
  },
  {
    title: "Startup Websites",
    description: "Launch-ready websites focused on visibility and growth.",
  },
  {
    title: "Custom Solutions",
    description: "Tailored functionality built around your business requirements.",
  },
];
...
export function ServicesHeroSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const serviceItems = serviceItemsRef.current?.querySelectorAll<HTMLElement>(
        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:gap-12">
          ...
          <div className="w-full lg:w-[60%]">
            ...
            >
              ...
              <span className="font-medium">Services & Solutions</span>
            </div>
            ...
            >
              ...
              <span className="block">To Build Trust</span>
            ...
            >
              From business websites and startup launches to wedding planners, restaurants, and coaching institutes, we create websites that help businesses look professional, attract customers, and grow online.
            </p>
          ...
          {/* RIGHT COLUMN - Services Panel (40%) */}
          <div ref={servicesPanelRef} className="w-full lg:w-[40%] opacity-0">
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-md md:p-8">
              ...
              <div className="mt-6 flex flex-col gap-3">
                <div className="flex items-center gap-2">
                  <span className="text-sm text-white/50">Typical Delivery</span>
                  <span className="text-sm font-medium text-white">5-15 Business Days</span>
                </div>
                <div className="flex items-center gap-2">
