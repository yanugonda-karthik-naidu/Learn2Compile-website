...
const projects: CaseStudyProject[] = [
  ...
  },
  {
    ...
    features: [
      "Investor-ready hero with live demo",
      "Interactive feature comparisons",
      "Enterprise client showcases",
    ],
    websiteUrl: "",
    results: [
      { label: "Demo Requests", value: "+68%", icon: "🚀" },
      { label: "Core Vitals", value: "A+", icon: "💎" },
      { label: "Bounce Rate", value: "-35%", icon: "📉" },
    ],
    gradient: "from-violet-500/20 to-purple-500/20",
    accent: "#8B5CF6",
    mockupColors: { primary: "#8B5CF6", secondary: "#A78BFA" },
  },
  {
    id: "meridian-group",
    name: "Meridian Group",
    ...
    category: "business",
    tagline: "Premium Business Consulting, Redefined",
    features: [
      "Case study-led design approach",
      "Content hub with resource library",
      "Team profiles with LinkedIn",
    ],
    websiteUrl: "",
    results: [
      { label: "Qualified Leads", value: "+54%", icon: "🎯" },
      { label: "Page Depth", value: "+42%", icon: "📖" },
      { label: "Email Signups", value: "+89%", icon: "✉️" },
    ],
    gradient: "from-cyan-500/20 to-blue-500/20",
    accent: "#06B6D4",
    mockupColors: { primary: "#06B6D4", secondary: "#67E8F9" },
  },
  {
    id: "zenith-custom",
    name: "Zenith Custom",
    ...
    websiteUrl: "",
    results: [
      { label: "B2B Inquiries", value: "+67%", icon: "🏭" },
      { label: "Support Load", value: "-45%", icon: "💬" },
      { label: "Order Value", value: "+23%", icon: "📦" },
    ],
    gradient: "from-slate-500/20 to-zinc-500/20",
    accent: "#64748B",
    mockupColors: { primary: "#64748B", secondary: "#94A3B8" },
  },
];
